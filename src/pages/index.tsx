  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Rental - Streamlining Carsharing. Manage profiles, book vehicles, track usage, and assess performance all in one central hub. Simplifying your car rental experience."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Rental - Streamlining Carsharing. Manage profiles, book vehicles, track usage, and assess performance all in one central hub. Simplifying your car rental experience.`}
            </Text>
            <Box
