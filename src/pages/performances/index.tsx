...
export function PerformanceListPage(props: PerformanceListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPerformances({
        ...
        order: params.order,
        searchTermKeys: ['usage_data.contains', 'demand_data.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'usage_data', header: 'Usage Data', accessorKey: 'usage_data' },
    { id: 'demand_data', header: 'Demand Data', accessorKey: 'demand_data' },
